...
test(`productType export module
  should output a product types and
  all the attributes of different product types`
  + `file using a ${ENCODING} encoding`, async (t) => {
  t.timeoutAfter(30000) // 30s
  const expectedFileName1 = 'attributes.csv'
  const expectedFileName2 = 'products-to-attributes.csv'
  /* eslint-disable max-len */
  const expectedResult1 =
      'productType,name,type,attributeConstraint,isRequired,isSearchable,label.en,label.de,textInputHint,displayGroup\n'
    + 'custom-product-type,breite,number,None,false,false,EN:žluťoučký kůň úpěl ďábelské ódy,DE:ě=ášéýřéý=čáěéžěížěé,SingleLine,Other\n'
  const expectedResult2 = 'name,key,description,breite\n'
    + 'custom-product-type,productTypeKey,Some description - žluťoučký kůň úpěl ďábelské ódy,X\n'
  ...
  let expectedEncoded1 =
    'productType,name,type,attributeConstraint,isRequired,isSearchable,label.en,label.de,textInputHint,displayGroup\n'
    + 'custom-product-type,breite,number,None,false,false,EN:�lu�ou�k� k�� �p�l ��belsk� �dy,DE:�=�������=����������,SingleLine,Other\n'

  if (process.version[1] >= 8)
    expectedEncoded1 = 'productType,name,type,attributeConstraint,isRequired,isSearchable,label.en,label.de,textInputHint,displayGroup\n'
    + 'custom-product-type,breite,number,None,false,false,EN:�lu�ou�k� k�� �p�l ��belsk� �dy,DE:�=������=��������,SingleLine,Other\n'
